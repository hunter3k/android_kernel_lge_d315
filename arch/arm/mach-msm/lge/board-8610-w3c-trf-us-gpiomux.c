...
static int gpio_reserved_pin_rev_0[] = {
	1, 7, 14, 15, 18, 19, 28, 29, 32, 33, 34, 35, 36, 37, 38, 39, 44, 46, 50, 51, 52, 53, 54, 55, 56, 58, 61, 62, 
    67, 68, 69, 70, 71, 75, 78, 82, 84, 86, 87, 88, 89, 91, 92, 93, 94, 95, 96, 97, 98, 99,
	MSM8x10_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};

static int gpio_reserved_pin_rev_A[] = {
	1, 7, 14, 15, 18, 19, 28, 29, 32, 33, 34, 35, 36, 37, 38, 39, 44, 46, 50, 51, 52, 53, 54, 55, 56, 58, 61, 62, 
    67, 68, 69, 70, 71, 75, 78, 82, 84, 85, 86, 87, 88, 89, 90, 92, 94, 95, 96, 97, 98, 99, 100,
	MSM8x10_GPIO_END // This is included to notify the end of reserved GPIO configuration.
};
