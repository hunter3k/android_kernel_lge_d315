...
void __init msm8226_init_gpiomux(void)
{
	...
	if(hw_rev <= HW_REV_A) {
		...
		printk(KERN_ERR " [Camera] greater than HW_REV_B is using power source from Ex-LDO used GPIO\n");
	}
	// GPIO related function <<8.FLASH LED>>
