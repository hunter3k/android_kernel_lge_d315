...
static int gpio_reserved_pin_rev_0[] = {
	0, 1, 2, 3, 12, 13, 14, 15, 17, 31, 34, 49, 50, 51, 52, 53, 54, 55, 56, 60, 63, 64, 65, 75, 76, 83, 84, 85, 86, 88, 89, 90, 94, 95, 96, 114, 115, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
static int gpio_reserved_pin_rev_A[] = {
	0, 1, 2, 3, 12, 13, 14, 15, 17, 31, 45, 46, 49, 50, 51, 52, 53, 54, 56, 60, 63, 64, 65, 75, 76, 83, 84, 85, 86, 88, 89, 90, 94, 95, 96, 114, 115, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
// Rev A -34, +45, +46, -55
...
static struct msm_gpiomux_config msm_atmel_configs_rev_c[] __initdata = {
	{
		.gpio = 17,
		.settings = {
...
void __init msm8226_init_gpiomux(void)
{
	...
	if(hw_rev <= HW_REV_A) {
		...
		msm_gpiomux_install(msm_atmel_configs_rev_c, ARRAY_SIZE(msm_atmel_configs_rev_c));
		printk(KERN_ERR "[Touch] HW_REV_C or above use Atmel \n");
	}
